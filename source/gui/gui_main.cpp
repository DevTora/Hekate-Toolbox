...
GuiMain::GuiMain() : Gui() {
    ...
    overrideKeysMenuButton->drawAction = [&](Gui *gui, u16 x, u16 y, bool *isActivated) {
        ...
        gui->drawTextAligned(font14, x + 100, y + 185, currTheme.textColor, "修改按键覆盖", ALIGNED_CENTER);
    };
    ...
    autobootSelectorButton->drawAction = [&](Gui *gui, u16 x, u16 y, bool *isActivated) {
        gui->drawTextAligned(font20, x + 37, y + 50, currTheme.textColor, "Hekate 自动启动配置", ALIGNED_LEFT);
    ...
    autobootSelectorButton->inputAction = [&](u32 kdown, bool *isActivated) {
        if (kdown & HidNpadButton_A) {
            ...
            (new ListSelector("Hekate 自动启动配置", "\uE0E1 返回     \uE0E0 确定", autobootNames, currAutoBootEntryIndex))
    ...
    backgroundServicesButton->drawAction = [&](Gui *gui, u16 x, u16 y, bool *isActivated) {
        ...
        gui->drawTextAligned(font20, x + 37, y + 50, currTheme.textColor, "后台服务", ALIGNED_LEFT);
    };
    ...
    rebootButton->drawAction = [&](Gui *gui, u16 x, u16 y, bool *isActivated) {
        ...
        gui->drawTextAligned(font20, x + 55, y + 50, currTheme.textColor, "重启到 Hekate", ALIGNED_LEFT);
    };
...
void GuiMain::draw() {
    ...
    Gui::drawTextAligned(font24, Gui::g_framebuffer_width / 2, Gui::g_framebuffer_height - 130, currTheme.textColor, "按 \uE044 保存并返回主菜单", ALIGNED_CENTER);
